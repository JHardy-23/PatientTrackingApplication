...
public class GUI_DoctorHomepage {
	...
	private void initialize() {
		...
		RegistrationTitleLabel.setFont(new Font("Algerian", Font.PLAIN, 55));
		RegistrationTitleLabel.setBounds(110, 0, 534, 91);
		...
		AppointmentsButton.setBackground(new Color(255, 228, 225));
